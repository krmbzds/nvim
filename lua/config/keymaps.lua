...
keymap("n", "<C-\\>", "<cmd>lua require('snacks').terminal.toggle()<cr>", opts)
keymap("i", "<C-\\>", "<esc><cmd>lua require('snacks').terminal.toggle()<cr>", opts)
keymap("t", "<C-\\>", "<cmd>lua require('snacks').terminal.toggle()<cr>", term_opts)
keymap("v", "<C-\\>", "<cmd>lua require('snacks').terminal.toggle()<cr>", opts)
